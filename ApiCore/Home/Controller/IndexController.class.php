...
class IndexController extends APIController
{
    ...
    public function operate()
    {
        switch (I('mod', '', 'htmlspecialchars')) {
            ...
            case "navinfo":
                ...
                break;
            case "userinfo":
                //Userinfo need token authentification for global
                self::verifyTOKEN(I('token', '', 'htmlspecialchars'));
                if (I('type', '', 'htmlspecialchars') != 'write') {
	...
	/**
	 * Site baseinfo management
	 * @param string $data JSON Configure String
	...
	/**
	 * Photo info management
	 * @param integer $m_pid Photo ID
	 * @param string $data JSON Configure String
	 * @return string Operation Result
	 */
	...
	/**
	 * Cover info management
	 * @param integer $m_cid Cover ID
	 * @param string $data JSON Configure String
	 * @return string Operation Result
	 */
	...
	/**
	 * Navigation info management
	 * @param integer $nid Navigation ID
	 * @param string $data JSON Configure String
	 * @return string Operation Result
	 */
	 ...
	 * @param string $s_token Access Token
	 * @return mixed Block Result
	 */
	...
	/**
	 * Predefine error response
	 * @param integer $code Error number
	 * @return string Error detail json info
	 */
